...
from ..ext.bot_utils import SetInterval
from ..ext.exceptions import TgLinkException
from ..ext.status_utils import get_readable_message

DOWNLOAD_DIR = Config.DOWNLOAD_BASE_DIR
status_dict = {}
task_dict_lock = None
intervals = {}
